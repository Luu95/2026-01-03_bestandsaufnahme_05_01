/// Einheitliche Farbpalette und formularbezogene Theme-Farben.
/// App-Blau ohne bunte Akzente; [AnlageFormTheme] für Dark Mode und Validierung.
...
class AppPalette {
  ...
  /// Abstufungen für Listen/Chips nach Index.
  ...
  /// Wählt eine Schattierung zyklisch anhand von [index].
  static Color shadeForIndex(int index) =>
      shadeSteps[index.abs() % shadeSteps.length];

  /// Hintergrundfarbe für Feldtyp-Badges (int/date/dropdown/…).
  ...
  /// Rahmenfarbe für Feldtyp-Badges.
  ...
  /// Fortschrittsfarbe nach Erfüllungsgrad (Prozent).
  ...
  /// Motivations-/Akzentfarbe für Fortschrittsanzeigen.
