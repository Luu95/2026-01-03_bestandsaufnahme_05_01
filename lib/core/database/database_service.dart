/// Domänen-Persistenzschicht über Drift ([AppDatabase]).
/// Mappt DB-Zeilen auf App-Modelle, cached Listen und nutzt Prefs nur für Flags.
import 'dart:convert';
import 'dart:io';
...
import 'package:bestandsaufnahme_01/features/projects/models/project.dart' as models;
import 'package:bestandsaufnahme_01/features/projects/models/building.dart' as models;
import 'package:bestandsaufnahme_01/features/floor_plans/models/floor_plan.dart' as models;
import 'package:bestandsaufnahme_01/features/systems/models/anlage.dart' as models;
...
/// In-Memory-Cache für Anlagenlisten eines Gebäudes (gesamt / nach Disziplin).
...
class DatabaseService {
  ...
  /// Ob für dieses Gebäude bereits Disziplinen angelegt wurden (Prefs-Flag).
  ...
  /// Lädt alle aktiven Projekte inkl. Gebäude und Grundrisse (ohne Anlagen).
  ...
  /// Einzelnes aktives Projekt inkl. Gebäude.
  ...
  /// Legt Projekt und zugehörige Gebäude an.
  ...
  /// Aktualisiert Projektstammdaten und synchronisiert Gebäude (Soft-Delete fehlender).
  ...
  /// Soft-Delete: Projekt und alle Gebäude in den Papierkorb.
  ...
  /// Stellt Projekt und soft-gelöschte Gebäude wieder her.
  ...
  /// Endgültiges Löschen eines Projekts (ohne Soft-Delete).
  Future<void> permanentlyDeleteProject(String id) async {
    await _db.deleteProject(id);
  }

  /// Projekte im Papierkorb inkl. soft-gelöschter Gebäude.
  ...
  /// Aktive Gebäude eines Projekts (Grundrisse, ohne Anlagen).
  ...
  /// Fügt Gebäude und Grundrisse ein (Anlagen separat).
  ...
  /// Aktualisiert Gebäude und Grundrisse – nicht die Anlagen (siehe Inline-Hinweis).
  ...
  /// Soft-Delete: Gebäude und zugehörige Anlagen.
  ...
  /// Stellt Gebäude und soft-gelöschte Anlagen wieder her.
  ...
  /// Endgültiges Löschen eines Gebäudes.
  ...
  /// Soft-gelöschte Gebäude eines Projekts.
  ...
  /// Speichert einen Grundriss für ein Gebäude.
  ...
  /// Aktualisiert Name und optional PDF-Pfad/-Name eines Grundrisses.
  ...
  /// Legt eine Anlage an und invalidiert den Listen-Cache des Gebäudes.
  ...
  /// Speichert Änderungen an einer Anlage und invalidiert den Listen-Cache.
  ...
  /// Alle Anlagen der aktiven Gebäude eines Projekts (optional Extra-Gebäude).
  ...
  /// Aktive Anlagen eines Gebäudes (mit Listen-Cache).
  ...
  /// Aktive Anlagen eines Gebäudes gefiltert nach Disziplin-Label (gecached).
  ...
  /// Einzelne aktive Anlage inkl. gemergtem Disziplin-Schema.
  ...
  /// Direkte Kind-Anlagen (Bauteile) einer Eltern-Anlage.
  ...
  /// Soft-Delete einer Anlage inkl. aller Kinder rekursiv.
  ...
  /// Stellt eine Anlage und soft-gelöschte Kinder wieder her.
  ...
  /// Endgültiges Löschen einer Anlage inkl. Kinder.
  ...
  /// Soft-gelöschte Anlagen aller Gebäude.
  ...
  /// Anzahl aller Anlagen-Zeilen eines Gebäudes (aktiv + soft-gelöscht).
  ...
  /// Anzahl der Gewerkevorlagen eines Projekts.
  ...
  /// Disziplinen eines Gebäudes, alphabetisch nach Label.
  ...
  /// Speichert oder ersetzt eine Disziplin und setzt das Initialisierungs-Flag.
  ...
  /// Ersetzt alle Disziplinen eines Gebäudes atomar.
  ...
  /// Entfernt eine Disziplin anhand des Labels.
  ...
  /// Wie [getProjectIdByBuildingId], inkl. soft-gelöschter Gebäude.
  ...
  /// Projektname auch für soft-gelöschte Projekte (z. B. Papierkorb-UI).
