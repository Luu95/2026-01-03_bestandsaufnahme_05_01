/// Riverpod-State für Projekt- und Gebäudeauswahl sowie CRUD.
/// Lädt Daten über [DatabaseService] und hält Auswahlindizes für die UI.
import 'dart:async';
...
/// Unveränderlicher UI-State: Projektliste, Ladezustand, Auswahl und Fehler.
class ProjectsState {
  ...
  /// Aktuell ausgewähltes Projekt oder `null` bei ungültigem Index.
  ...
  /// Aktuell ausgewähltes Gebäude im [selectedProject].
...
/// StateNotifier für Laden, Auswahl und Soft-Delete von Projekten/Gebäuden.
class ProjectsNotifier extends StateNotifier<ProjectsState> {
  ...
  /// Löscht [ProjectsState.lastError].
  void clearError() {
  ...
  /// Wählt ein Projekt aus und setzt das erste Gebäude (falls vorhanden).
  ...
  /// Wählt ein Gebäude im aktuellen Projekt aus.
  ...
  Future<void> deleteProjects(List<int> indices) async {
    try {
      // Absteigend, damit Indizes nach removeAt gültig bleiben.
  ...
  /// Aktualisiert das aktuell ausgewählte Gebäude.
  ...
  /// Fügt ein Gebäude zum aktuellen Projekt hinzu und lädt den State neu.
