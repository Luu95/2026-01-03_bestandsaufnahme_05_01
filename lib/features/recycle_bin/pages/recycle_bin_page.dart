/// Papierkorb: soft-gelöschte Projekte, Gebäude und Anlagen wiederherstellen
/// oder endgültig löschen. Geschachtelte Treffer (z. B. Anlagen unter einem
/// bereits gelöschten Gebäude) werden ausgeblendet, um Doppelungen zu vermeiden.
...
/// UI für den Papierkorb (Restore / Hard-Delete).
...
/// Lädt gelöschte Entitäten und filtert geschachtelte Einträge heraus.
class _RecycleBinPageState extends ConsumerState<RecycleBinPage> {
  ...
  Future<void> _loadDeletedItems() async {
    ...
    // Gebäude unter gelöschten Projekten nicht separat listen (Restore über Projekt).
    ...
    // Anlagen unter gelöschten Gebäuden ausblenden (gleiche Begründung).
