/// Offline-Spracherkennung (Diktat) für Anlagen-Felder über die Geräte-API.
/// Singleton; benötigt Mikrofon-Berechtigung und ggf. Offline-Sprachpaket.
...
class SpeechService {
  ...
  /// Initialisiert Engine und Mikrofon; wählt eine deutsche Locale, falls vorhanden.
  ...
  /// Wählt bevorzugt eine deutsche Locale-ID aus den verfügbaren Speech-Locales.
  ...
  /// Bricht laufendes Diktat ab und setzt die Engine zurück.
