/// OCR-Erkennung von Typenschild-Feldern aus Fotos (ML Kit Text Recognition).
/// Kombiniert geografische, block-, regex- und kontextbasierte Extraktionsstrategien.
...
/// Statischer Service zur Erkennung typischer Anlagen-Attribute auf Typenschildern.
class OcrService {
  ...
  /// Gibt den TextRecognizer frei (App-Lifecycle / Dispose).
  static void dispose() {
