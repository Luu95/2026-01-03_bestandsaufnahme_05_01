/// Anlagenübersicht eines Gewerks: hierarchische Liste, Selection und Dialoge.
///
/// UI-Expand-/Scroll-State liegt in [SystemsUiStore] (nur Laufzeit, nicht DB).
...
import 'package:bestandsaufnahme_01/features/systems/widgets/anlage_hierarchical_item.dart';
import 'package:bestandsaufnahme_01/features/systems/widgets/systems_anlage_list.dart';
import 'package:bestandsaufnahme_01/features/systems/widgets/anlage_dialog/open_add_anlage_with_template_prefill.dart';
import 'package:bestandsaufnahme_01/features/systems/pages/systems_ui_store.dart';
...
/// Seite mit der Anlagenliste für ein Gewerk in einem Gebäude/Grundriss.
class SystemsPage extends ConsumerStatefulWidget {
  /// Gebäude, zu dem die Anlagen gehören.
  final Building building;
  /// Aktueller Grundriss-Kontext (Floor-ID für Marker/Placement).
  final FloorPlan floor;
  /// Gewerk, dessen Anlagen angezeigt werden.
...
/// Öffentlicher State der Anlagenübersicht (für GlobalKey von außen erreichbar).
class SystemsPageState extends ConsumerState<SystemsPage>
    with RouteAware, TickerProviderStateMixin {
  List<Anlage> _alleAnlagen = [];
  ...
  final Set<String> _selectedAnlagenIds = {};
  ...
  Future<void> _openAnlageErfassungAfterPlacement({
    ...
    await openAddAnlageWithTemplatePrefill(
      ...
      floorId: widget.floor.id,
      projectId: projectId,
      persistParentInHelper: false,
      isMounted: () => mounted,
      onSaved: (newAnlage) async {
